# 1.8.9ForgeTemplateFixedVersion

A fixed and ready to use template for minecraft forge modding on `1.8.9`
with `shadow` plugin integrated including two useful `artifacts`. Tested flawlessly on `IntelliJ IDEA Ultimate 2025.1.3`
...
Note: This is a edited version of [Dxxxxy](https://github.com/dxxxxy/1.8.9ForgeTemplate)'s 1.8.9 Forge Template. I upgraded gradle to 4.5 and let it support newer version of IDEA.